...
public class Main2Activity extends AppCompatActivity {
    ...
    String mDescription[] = {"• Fully furnished Medium Room For Rent \n\n" +
            ...
            "• Partially furnished Medium room \n\n" +
                    "• 5 minutes to ucsi\n\n" +
            ...
            "• Fully furnished Medium Room For Rent \n\n" +
                    "• single bed for one person only\n\n" +
                    "• near ucsi university\n\n" +
                    "• 5 minutes to mamak by walking\n\n" +
                    "• 5 minutes Pizza Hut, KFC and 99 speedmart \n\n" +
    ...
    String mPrice[] = {"RM 435", "RM 550 ", "RM 500 ", "RM 650", "RM 700 ","RM 625"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Main2Activity.MyAdapter adapter = new Main2Activity.MyAdapter(this, mTitle, mDescription, images,mPrice);
    ...
    class MyAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            TextView myPrice = row1.findViewById(R.id.textView3);
